...
**Using the console**, and in a folder with the script called "Input_Bams.txt", the bash script (CHASM_input) can produce data for RChASM using the following command. Please note that this is _not_ run in R.
